    ...
    <div className="container mx-auto px-4 py-12 max-w-2xl min-h-[85vh]">
      <div className="bg-white rounded-3xl shadow-xl p-8 border border-slate-100">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2 text-sm">Fill in the details to add a premium vehicle to the Fleet.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-bold text-slate-700 mb-2">Car Name</label>
              <input
                type="text"
                name="carName"
                required
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block text-sm font-bold text-slate-700 mb-2">Seats Capacity</label>
              <input
                type="number"
                name="seats"
                required
