        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div>
            ...
            <p className="text-slate-600 text-sm md:text-base leading-relaxed">
              {car.description ||
                "No specific overview provided for this premium vehicle. Experience ultimate comfort and superior performance with our carefully inspected fleet."}
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-slate-600">
              <span className="flex items-center gap-2">
                <FaCheckCircle className="text-emerald-500 shrink-0" /> Free
                Cancellation
              </span>
              <span className="flex items-center gap-2">
                <FaCheckCircle className="text-emerald-500 shrink-0" /> Full
                Tank Fuel Option
              </span>
              <span className="flex items-center gap-2">
                <FaCheckCircle className="text-emerald-500 shrink-0" /> 24/7
                Roadside Assistance
              </span>
              <span className="flex items-center gap-2">
                <FaCheckCircle className="text-emerald-500 shrink-0" /> Clean &
                Sanitized Interior
              </span>
            </div>
          </div>
